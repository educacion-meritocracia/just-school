...
- Menú desplegable de décimas a regalar desde 0.0 a 0.5 
...
- Menú desplegable de décimas a regalar desde 0.0 a 1.0
...
- Estudiantes tienden a aprobar a quién se **esfuerza más**, *independientemente* de sus oportunidades de origen
