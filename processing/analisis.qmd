...
modelo8 <- lm(justicia_nota ~ genero_ES + curso_estudiante + educ_max + libros_hogar + rendimiento + notas_esfuerzo + social_merito_percep_ES + merit_esfuerzo_percep_ES, data = proc_datos)
modelo9 <- lm(justicia_nota ~ genero_ES + curso_estudiante + educ_max + libros_hogar + rendimiento + notas_esfuerzo + social_merito_percep_ES + merit_esfuerzo_percep_ES + merit_talento_percep_ES, data = proc_datos)
modelo10 <- lm(justicia_nota ~ genero_ES + curso_estudiante + educ_max + libros_hogar + rendimiento + notas_esfuerzo + social_merito_percep_ES + merit_esfuerzo_percep_ES + merit_talento_percep_ES + school_merito_ES, data = proc_datos)
modelo11 <- lm(justicia_nota ~ genero_ES + curso_estudiante + educ_max + libros_hogar + rendimiento + notas_esfuerzo + social_merito_percep_ES + merit_esfuerzo_percep_ES + merit_talento_percep_ES + school_merito_ES + school_esfuerzo_ES, data = proc_datos)
modelo12 <- lm(justicia_nota ~ genero_ES + curso_estudiante + educ_max + libros_hogar + rendimiento + notas_esfuerzo + social_merito_percep_ES + merit_esfuerzo_percep_ES + merit_talento_percep_ES + school_merito_ES + school_esfuerzo_ES + school_talento_ES, data = proc_datos)


sjPlot::tab_model(list(modelo1, modelo2,modelo3, modelo4,modelo5, modelo6, modelo7, modelo8, modelo9, modelo10, modelo11, modelo12), show.ci=FALSE, p.style = "stars", dv.labels = c("Modelo 1", "Modelo 2", "Modelo 3", "Modelo 4", "Modelo 5", "Modelo 6", "Modelo 7", "Modelo 8", "Modelo 9", "Modelo 10", "Modelo 11", "Modelo 12" ),string.pred = "Predictores", string.est = "β")

#plot(modelo5, which = 1)  # Residuals vs Fitted plot

plot_model(modelo12, show.values = TRUE)+ theme_sjplot()
